...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            training_logs = self.train_agent()  # HW1: DONE
    ...
    def collect_training_trajectories(
        ...
        if itr == 0 and load_initial_expertdata is not None:
            print("\nLoading the initial expert data...")
            with open(load_initial_expertdata, 'rb') as exp_data:
                loaded_paths = pickle.load(exp_data)
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            if (train_step % 100 == 0):
                print(
                    f"{train_step}/{self.params['num_agent_train_steps_per_iter']} trainsteps")
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        for path in paths:
            path["action"] = expert_policy.get_action(
                path["observation"])
