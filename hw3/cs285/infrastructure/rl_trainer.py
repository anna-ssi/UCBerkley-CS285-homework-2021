...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        register_custom_envs()
        # self.env = gym.make(self.params['env_name']) if 'LunarLander' in self.params['env_name'] else gym.make(
        #     self.params['env_name'], render_mode='human')
        ...
        if 'env_wrappers' in self.params:
            ...
            self.env = wrappers.RecordVideo(
                self.env,
                video_folder=os.path.join(self.params['logdir'], "gym"),
                
                # force=True,
                # video_callable=(
                #     None if self.params['video_log_freq'] > 0 else False),
            )
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in tqdm(range(n_iter), desc='Iteration'):
    ...
    def collect_training_trajectories(
        ...
        # TODO not sure about min_timesteps_per_batch is batch_size or not
    ...
    def train_agent(self):
        ...
        for _ in range(self.params['num_agent_train_steps_per_iter']):
            ...
            self.episode_rewards.append(re_batch)
    ...
    def perform_dqn_logging(self, all_logs):
        ...
        self.episode_rewards = np.concatenate(self.episode_rewards)

        if len(self.episode_rewards) > 0:
            self.mean_episode_reward = np.mean(self.episode_rewards[-100:])
